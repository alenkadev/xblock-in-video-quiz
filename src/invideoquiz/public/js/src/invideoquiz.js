        ...
        $.each(problemTimesMap, function(time, componentId) {
            normalizeProblemIds(componentId).forEach(function(id) {
                if (componentMatchesId(component, id)) {
                    ...
                    var safeDisplayTime = $('<div>').text(displayTime).html();
                    var timeParagraph = '<p class="in-video-alert"><i class="fa fa-exclamation-circle"></i>This component will appear in the video at <strong>' + safeDisplayTime + '</strong></p>';
